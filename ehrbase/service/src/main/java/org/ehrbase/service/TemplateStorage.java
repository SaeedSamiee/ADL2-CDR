...
public interface TemplateStorage {
    ...
    /**
     * Save an ADL2 template in the store.
     *
     * @param templateId template identifier
     * @param adl2Source original ADL2 ADL or JSON source
     * @param adl2OptJson canonical Archie OPT JSON
     */
    TemplateMetaData storeAdl2Template(String templateId, String adl2Source, String adl2OptJson);
