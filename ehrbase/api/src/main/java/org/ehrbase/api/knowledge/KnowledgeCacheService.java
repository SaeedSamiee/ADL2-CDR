...
public interface KnowledgeCacheService {
    ...
    /**
     * Register an ADL2 operational template (Archie JSON or ADL source stored alongside metadata).
     *
     * @param templateId stable template id
     * @param adl2Source ADL2 ADL text or Archie OPT JSON
     * @param adl2OptJson canonical Archie OPT JSON for storage
     * @return template id
     */
    String addAdl2OperationalTemplate(String templateId, String adl2Source, String adl2OptJson);

    Optional<String> retrieveAdl2OperationalTemplate(String templateId);

    Optional<String> retrieveAdl2OperationalTemplateAdl(String templateId);
}
